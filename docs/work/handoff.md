...
- 新增 change：`docs/changes/CHG-032-roxy-add-phone-transition-guard.md`，状态 `implemented`，尚未合并 PRD。
...
- 新增 change：`docs/changes/CHG-033-roxy-callback-cdp-fallback.md`，状态 `implemented`，尚未合并 PRD。
...
- 新增 change：`docs/changes/CHG-034-roxy-phone-code-transition-guard.md`，状态 `implemented`，尚未合并 PRD。
...
- 新增 change：`docs/changes/CHG-035-roxy-token-page-context-retry.md`，状态 `implemented`，尚未合并 PRD。
