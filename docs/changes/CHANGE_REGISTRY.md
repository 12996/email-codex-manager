...
| CHG-038 | 前端列表取消局部竖向滚动并显示补号备注 | implemented | 2026-06-05 | PRD-002 | `web/index.html`, `web/app.js`, `web/styles.css`, `test/replacementAccountsWeb.test.js`, `test/accountsWebApi.test.js`, `docs/work/` | `CHG-038-frontend-list-remark-no-inner-scroll.md` |
| CHG-039 | 避免 Windows 保留 3000 端口导致启动失败 | implemented | 2026-06-06 | PRD-002 | `.env.example`, `README.md`, `docs/project/api.md`, `docs/project/deployment.md`, `src/auto/`, `test/` | `CHG-039-avoid-windows-port-3000-eacces.md` |
| CHG-040 | Roxy OAuth 密码页 one-time code 与邮箱后异常重试 | implemented | 2026-06-06 | PRD-002 | `src/auto/roxy_oauth_login.js`, `test/roxyOauthLogin.test.js`, `docs/work/` | `CHG-040-roxy-openai-password-one-time-code.md` |
